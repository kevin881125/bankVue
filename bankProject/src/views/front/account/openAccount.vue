      ...
      <main class="form-area">
        <div class="form-card">
          <div class="padded">
            ...
            <div class="form-group">
              <div class="field-label with-captcha">
                ...
                <div class="captcha-box">
                  <img
                    class="captcha-img"
                    src="https://dummyimage.com/96x36/e5e7eb/222626&text=39375"
                    alt="captcha"
                  />
            ...
            <!-- 下一步 -->
            <div class="btn-row">
              <button class="next-btn" :disabled="!canNext" @click="nextStep">
                下一步
              </button>
            </div>
...
function nextStep() {
  ...
  // 前往下一步或送出
  // router.push('/yuzubank/openAccount/step2')
  console.log("go next with:", {
    ...form.value,
    otpPassed: otpPassed.value,
  });
}
